...
//            - "즉시 처리해드리겠습니다" 등 Tool 없이는 임의로 처리하는 표현을 사용하지 않습니다.
    ...
    public static final String COMMON_PROMPT = """
            ...
            - 배달 지연, 보상 관련 질문 → "배달 지연" 관련 문서를 우선 참고합니다.
            - 환불, 취소, 반품 관련 질문 → "환불" 관련 문서를 우선 참고합니다.
            - 배달 지연으로 인한 환불 요청 → "배달 지연" 관련 문서 우선 적용하고 해결이 안 될 경우 "환불 관련 문서"를 참고합니다.
            - Context에서 답을 찾을 수 없으면 추측하지 말고 아래와 같이 답합니다:
            "해당 내용은 확인이 필요합니다. 상담원 연결로 도와드리겠습니다."
            - 정책을 인용할 때는 원문의 수치/조건을 원문 그대로 사용합니다. 임의로 변경하거나 반올림하지 않습니다.
